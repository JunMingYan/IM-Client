        ...
        <div class="wrapper">
          ...
          <div class="conversation-detail">
            ...
            <span class="bottom-item secondary-font detail-item ellipsis space-bw" style="display: flex">
              ...
              <span v-if="type === 'recent' && lastNews" style="margin-left: 5px">{{this.conversationInfo.lastNews.sendTime | formatDateToZH}}</span>
            </span>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      showMenu(e) {
        ...
        console.log(IMG_URL)
        console.log(this.conversationInfo.photo)
      },
      hiddenMenu() {
        this.isShowMenu = false
      }
