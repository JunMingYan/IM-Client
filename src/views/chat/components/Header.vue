    ...
    computed: {
      ...
      headerTitle() {
        ...
        if (currentConversation.isGroup) {
          ...
          res = this.beiZhu[currentConversation.id] ? this.beiZhu[currentConversation.id] + `（${currentConversation.nickname}）` : currentConversation.nickname
        }
        return res
      },
      ...mapState('app', {
