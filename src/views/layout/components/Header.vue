    ...
    <transition name="fade">
      <vue-draggable-resizable
        ...
        <div class="co-art-board">
          <co-art-board :currentconversation="currentConversation" :state="webRTCState"
  ...
  export default {
    ...
    computed: {
      ...
      validateUnReadCount() {
        ...
        const key = (validateSysUser || {}).sid + '-' + (this.userInfo || {}).userID
    ...
    watch: {
      isToCoArtBoard: { //监听白板协作这个变量，设置连接请求超时时间
        handler(newVal) {
